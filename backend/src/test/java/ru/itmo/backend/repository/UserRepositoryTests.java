...
public class UserRepositoryTests {
    ...
    @Test
    public void UserRepository_SaveUser_ValidationError(){
        UserEntity detective1 = new UserEntity();
        detective1.setPassword("password");
        detective1.setFirstName("Sherlock");
        detective1.setLastName("Holmes");
...
//    @Test
//    @Transactional
//    public void UserRepository_DeleteRole_ReturnUserIsEmpty() {
//        UserEntity detective1 = new UserEntity();
//        detective1.setLogin("sherDet");
//        detective1.setPassword("password");
//        detective1.setFirstName("Sherlock");
...
//        userRepository.save(detective1);
//
//        //roleRepository.deleteById(userRole1.getId());
//        //entityManager.clear();
//        entityManager.flush();
//        Optional<Role> deletedRole = roleRepository.findById(userRole1.getId());
//        Assertions.assertEquals(false, deletedRole.isEmpty());
//
//        Long userId = detective1.getId();
//        Long roleId = userRole1.getId();
//
//        Number count = (Number) entityManager.createNativeQuery("SELECT COUNT(*) FROM users_roles WHERE user_id = :userId AND role_id = :roleId")
