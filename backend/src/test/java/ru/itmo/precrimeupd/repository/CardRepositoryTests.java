...
public class CardRepositoryTests {
    ...
    @Test
    public void CardRepository_FindAllByResponsibleDetective_ReturnsCards(){
        CrimeCard card = CrimeCard.builder()
                .criminalName("Joe Barbaro")
                .victimName("Tommy Angelo")
                .weapon("Shotgun")
    ...
    @Test
    public void CardRepository_DeleteResponsibleDetective_CardNotDeleted(){
        CrimeCard card = CrimeCard.builder()
                .criminalName("Joe Barbaro")
                .victimName("Tommy Angelo")
                .weapon("Shotgun")
        ...
        CrimeCard cardD = cardRepository.findById(card.getId()).get();
        cardD.setResponsibleDetective(null);
        cardRepository.save(cardD);
        entityManager.flush();
        Assertions.assertNotNull(cardD.getId());
        Assertions.assertNotNull(cardD);
        Assertions.assertNull(cardD.getResponsibleDetective());
    }
